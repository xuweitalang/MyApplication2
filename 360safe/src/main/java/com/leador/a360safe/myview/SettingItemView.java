...
public class SettingItemView extends RelativeLayout {
    private static final String NAMESPACE = "http://schemas.android.com/apk/res/com.leador.a360safe";
    ...
    public SettingItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        initAttrs(attrs); //获取属性方法1

        // 获取属性方法2
        /*TypedArray array = context.obtainStyledAttributes(attrs,R.styleable.SettingItemView);
        mDestitle = array.getString(R.styleable.SettingItemView_destitle);
        mDesoff = array.getString(R.styleable.SettingItemView_desoff);
        mDeson = array.getString(R.styleable.SettingItemView_deson);*/
